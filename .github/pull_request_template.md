...
7. [ ] You have updated the inline code documentation and [README](https://github.com/chaqmoq/dotenv/blob/master/README.md) accordingly
...
[![Actions Status](https://github.com/chaqmoq/dotenv/actions/workflows/development.yaml/badge.svg?branch=your-branch-name)](https://github.com/chaqmoq/dotenv/actions/workflows/development.yaml?branch=your-branch-name)
